                ...
                <div class="catch-me" >
                    <div class="">
                        <el-tooltip  class="item"  content="Github" placement="top" >
                            <a  :href="'https://github.com/YuelinWang'" target="_blank" ><i class="fa fa-fw fa-github"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="QQ" placement="top">
                            <a  :href="'../../static/img//wyl/qq.jpg'" target="_blank"><i class="fa fa-fw fa-qq"></i></a>
                        </el-tooltip>
                    </div>
                    <div class="">
                        <el-tooltip class="item" effect="dark" content="微信" placement="top">
                            <a :href="'../../static/img//wyl/wechat.png'" target="_blank"><i class="fa fa-fw fa-wechat"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="bilibili" placement="top">
                            <a :href="'https://space.bilibili.com/391117803'" target="_blank"><i class="">Bi</i></a>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark" content="简历" placement="top">
                            <a :href="'http://www.wangyuelin.xyz/about/aboutme.html'" target="_blank"><i class="fa fa-fw fa-file-word-o"></i></a>
                        </el-tooltip>
                    </div>
                </div>
            </div>
