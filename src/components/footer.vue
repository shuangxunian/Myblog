...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        ...
        <div class="fcontainer">
            ...
            <p>
                <span>
					Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by YuelinWang.
					<a href="http://www.beian.miit.gov.cn/"> | 黑ICP备20002479号</a>
				</span>
            </p>
        </div>
    </div>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2020/07/05 00:00:00');
