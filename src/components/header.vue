...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/Message"><i class="fa fa-wa fa-pencil"></i> 笔记</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information">
			<a href="#/Aboutme">
                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/tou1.png'" alt="">
                </a>
			<h2 class="h-description">
                    <a href="#/Aboutme">
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"最怕一生碌碌无为，却说平凡难得可贵"}}
                    </a>
                </h2>
		</div>
	</div>
